...
import {
  ...
  getMyTickets, getCachedTickets, buyTicket, cacheTickets, initiatePayment,
} from "../api";
...
export default function EventsPage() {
  ...
  const hasTicket = (eventId) => myTickets.some((t) => t.eventId === eventId);

  const onBuyPress = (event) => {
  ...
  return (
    ...
    <View style={styles.container}>
          ...
          <View style={styles.legalModal}>
            ...
            >
              ...
              {[
                {
                  icon: "key",
                  title: "Billet unique et personnel",
                  text: "Chaque billet est unique et lié à votre compte. Il n'est pas transférable."
                },
                {
                  icon: "ban",
                  title: "Perte ou vol non couverts",
                  text: "En cas de perte ou de vol, nous déclinons toute responsabilité."
                },
                {
                  icon: "scale",
                  title: "Fraude interdite",
                  text: "Toute tentative de fraude engage votre responsabilité légale."
                },
                {
                  icon: "camera-off",
                  title: "Capture d'écran désactivée",
                  text: "La capture d'écran du QR code est bloquée."
                }
              ].map((item) => (
      ...
      >
        ...
        <View style={styles.overlayBottom}>
          ...
          <View style={styles.payModal}>
            ...
            {selectedEvent && (
              <>
                <Text style={styles.payEventName}>
                  {selectedEvent.title}
                </Text>

                <Text style={styles.payAmount}>
                  {formatAriary(selectedEvent.price)}
                </Text>
              </>
            )}
      ...
      {/* NOUVEAU : écran attente paiement */}
...
const styles = StyleSheet.create({
  ...
  overlay: {
    flex: 1,
    backgroundColor: "rgba(6,9,20,0.93)",
    justifyContent: "center",
    alignItems: "center",
    padding: SPACING.lg
  },
